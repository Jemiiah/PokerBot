...
interface IEscrow4Max {
    ...
    function deposit(bytes32 gameId, address player) external payable;
    function settle(bytes32 gameId, address winner, uint256 amount) external;
